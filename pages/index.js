  ...
  return (
    <div className="d-flex justify-content-center align-items-center vh-100 vw-100">
      ...
      >
            ...
            >
              ...
              <div className={`${styles.description} w-100`}>
                ...
                <span>
                  ...
                  Magnam facere exercitationem veritatis non consequatur sequi
                  beatae voluptate laboriosam asperiores fugit fugiat maxime
                  unde minima dolorem placeat accusantium, dolore libero
                  voluptatibus.
                </span>
              </div>
            </div>
        ...
        <div
          className={`${styles.interactions} d-flex align-items-center w-100`}
        >
