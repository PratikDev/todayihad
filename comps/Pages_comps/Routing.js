...
function Routing() {
  ...
  return (
    <>
      <div
        className={`position-fixed bottom-0 end-0 mb-5 me-3 d-flex flex-column align-items-center gap-2 ${styles.wrapper}`}
      >
        <div
          className={`py-3 bg-dark bg-opacity-50 border border-secondary border-opacity-75 rounded-pill d-flex flex-column-reverse justify-content-between align-items-center gap-3 overflow-hidden ${styles.routingBtnWrapper}`}
          tabIndex={0}
        >
          <svg
            ...
            className={`${styles.route_btn} cursor px-2 box-sizing-content`}
          >
          ...
          <div className="cursor" onClick={userSignOut} title={`Logout`}>
            <svg
              ...
              className={`${styles.route_btn} px-2 box-sizing-content`}
            >
          ...
          <Link href={`/user/${authContext.uid}`} title={`Profile`}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 448 512"
              width={25}
        ...
        >
          <svg
            ...
            height="40"
            fill="rgba(255,255,255,0.75)"
            className={`bi bi-plus-circle ${styles.newPostBtnIcon}`}
            viewBox="0 0 16 16"
          >
