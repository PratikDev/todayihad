...
function UserInfo() {
  return (
    <div
      className={`${styles.user_info_sec} rounded-1 bg-secondary bg-opacity-25 p-4 d-flex align-items-center justify-content-center flex-column gap-5`}
    >
      <div
      ...
      <button
        className={`btn bg-secondary bg-opacity-75 rounded-1 text-light d-flex align-items-center justify-content-center gap-2 w-100`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 448 512"
